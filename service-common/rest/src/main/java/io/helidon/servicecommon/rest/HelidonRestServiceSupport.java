...
public abstract class HelidonRestServiceSupport implements Service {
    ...
    protected <T extends HelidonRestServiceSupport, B extends Builder<T, B>> HelidonRestServiceSupport(Logger logger,
            Builder<T, B> builder,
            String serviceName) {
        this.logger = logger;
     ...
     */
    public abstract static class Builder<T extends HelidonRestServiceSupport, B extends io.helidon.common.Builder<T>>
