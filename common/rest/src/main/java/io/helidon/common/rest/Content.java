 ...
 * {@link #registerReader(Class, ServerRequest.Reader)} or {@link #registerReader(Predicate, ServerRequest.Reader)} methods. It
 * is then possible
 * to use {@link #as(Class)} method to obtain such entity.
 */
public interface Content extends Flow.Publisher<RequestChunk> {
     ...
     * {@link RequestChunk} in the {@link Flow.Subscriber#onNext(Object)} call
     ...
     * (see {@link #registerReader(Predicate, ServerRequest.Reader)}). If no such reader is found, the
